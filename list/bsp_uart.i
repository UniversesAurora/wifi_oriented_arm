...
void uart_send_string(USART_TypeDef* pUSARTx, char* str)
{
    ...
    while (USART_GetFlagStatus(pUSARTx,
                               ((uint16_t)0x0040)) == RESET);
}

int fputc(int ch, FILE* f)
{
    USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), (uint8_t) ch);

    while (USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),
                               ((uint16_t)0x0080)) == RESET);
...
{
    while (USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),
                               ((uint16_t)0x0020)) == RESET);

    return (int)USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
}
