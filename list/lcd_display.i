...
void init_lcd_display(void)
{
    ...
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000040), ENABLE);
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), &gpio_init_type);
...
{
    start_read_data();
    uint8_t data = (0xFF & GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800))));
    return data;
}
...
static void write_data(uint8_t data)
{
    ...
    for (; time < 8; time++)
    {
        ...
        {
        case 0:
            GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), 1 << time, Bit_RESET);
            break;

        case 1:
            GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), 1 << time, Bit_SET);
            break;
        }
...
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0100));
}
