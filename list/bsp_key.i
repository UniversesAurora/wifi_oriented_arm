...
static void init_exti(GPIO_TypeDef* port, uint16_t pin, GPIOMode_TypeDef mode, uint8_t ports, uint8_t pins)
{
...
void key_init(void)
{
    ...
    init_nvic(EXTI4_IRQn, 0, 0);
    init_nvic(EXTI3_IRQn, 0, 0);
    init_nvic(EXTI2_IRQn, 0, 0);
    init_nvic(EXTI0_IRQn, 0, 0);

    RCC_APB2PeriphClockCmd(((uint32_t)0x00000040) | ((uint32_t)0x00000040) | ((uint32_t)0x00000040) | ((uint32_t)0x00000004), ENABLE);
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000001), ENABLE);
    
    init_exti(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0010), GPIO_Mode_IPU, ((uint8_t)0x04), ((uint8_t)0x04));
    init_exti(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0008), GPIO_Mode_IPU, ((uint8_t)0x04), ((uint8_t)0x03));
    init_exti(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1800)), ((uint16_t)0x0004), GPIO_Mode_IPU, ((uint8_t)0x04), ((uint8_t)0x02));
    init_exti(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0001), GPIO_Mode_IPD, ((uint8_t)0x00), ((uint8_t)0x00));
}
