...
void init_lcd_display(void)
{
    ...
    gpio_init_type.GPIO_Pin =  ((uint16_t)0x0100);
...
static void set_data_pin_gpio(GPIO_InitTypeDef*
                              gpio_init_type)
{
    gpio_init_type->GPIO_Pin =  ((uint16_t)0x0001);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
    gpio_init_type->GPIO_Pin =  ((uint16_t)0x0002);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
    ...
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
    gpio_init_type->GPIO_Pin =  ((uint16_t)0x0020);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
    gpio_init_type->GPIO_Pin =  ((uint16_t)0x0040);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
    gpio_init_type->GPIO_Pin =  ((uint16_t)0x0080);
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), gpio_init_type);
}
...
{
    start_read_data();
    uint8_t data = (0xFF & GPIO_ReadInputData(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00))));
    return data;
}
...
static void write_data(uint8_t data)
{
    ...
    for (; time < 8; time++)
    {
        ...
        {
        case 0:
            GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), 1 << time, Bit_RESET);
            break;

        case 1:
            GPIO_WriteBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), 1 << time, Bit_SET);
            break;
        }
...
{
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0100));
}

static void rs_reset(void)
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0100));
}

static void rw_set(void)
{
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0800));
}

static void rw_reset(void)
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x0800));
}

static void e_set(void)
{
    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x1000));
}

static void e_reset(void)
{
    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1C00)), ((uint16_t)0x1000));
}
...
void lcd_get_new_line(void)
{
    ...
    addr_cur &= ~0b10000000;
    int cur_line = addr_cur / 0x40;
    lcd_set_ddram_ptr(cur_line >= 2 - 1 ?
                      (2 - 1) * 0x40 :
                      (cur_line + 1) * 0x40);
}
...
char* lcd_get_string(int row, int col, int num)
{
    ...
    if (num < 2 * 16)
        ...
        str_buf = malloc(2 * 16 + 1);

    if (!str_buf)
        return 0;

    read_addr = row * 0x40 + col;
    line_count = col;
...
void lcd_print(char* string, int row, int col)
{
    ...
    for (row_iter = row; row_iter < 2; row_iter++)
    {
        if (row_iter == row)
        {
            lcd_print_line(string, row, col);
